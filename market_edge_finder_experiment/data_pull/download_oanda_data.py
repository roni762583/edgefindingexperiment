#!/usr/bin/env python3
"""
Edge Finding Experiment - OANDA Data Downloader
Memory-efficient historical data downloader for 20 FX pairs
Adapted for TCNAE + LightGBM hybrid system with cross-instrument context
"""
...
class EdgeFindingOandaDownloader:
    """
    Memory-efficient Oanda data downloader for Edge Finding Experiment
    Downloads data for 20 FX pairs in <5000 bar batches and saves incrementally to CSV
    Supports parallel downloads and cross-instrument data synchronization
    """
...
def main():
    ...
    parser.add_argument("--instrument", default="EUR_USD", help="Forex instrument")
    ...
    try:
        # Create downloader
        downloader = EdgeFindingOandaDownloader.from_env_file(args.env_file, args.environment)
